...
const GetCreative = ({ user }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className=" flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 mb-5 lg:w-4/5  w-full">
        <input
          type="text"
